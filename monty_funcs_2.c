 ...
 * @stack: A pointer to teh topmode node of a stack_t linked list.
 ...
 * @line_number: The current working line number of a monty bytecodes fileb
 *
...
/**
 * monty_mul - multiplies the second value from the top of a stack by the top
 * @stack: A pointer to the top mode node of a stack_t linked list
 * @line_number: The current working line number of a monty bytecodes file
 * Description: The result is stored in the second value node from the top
 */
...
/**
 * monty_mod - computes the modulus of the second value by the top value
 * @stack: A pointer tot he top mode node of a stack_t linked list
 * @line_number: The current working line number of a monty bytecodes file
 * Description: the result is stored in the second value node from the top
 */
void monty_mod(stack_t **stack, unsigned int line_number)
